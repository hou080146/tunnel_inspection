...
class ysOnnx {
//public:
//    static ysOnnx & instance() {
//        static ysOnnx the_instance;
//        the_instance.ReadModel("backgroundall.onnx", true, 0, true);
//        return the_instance;
//    }
public:
    std::vector<std::string> _className = {
        "seepage","seepage","fall_block","mileage"//,"shield"裂纹、渗水、掉块
    };
public:
    ysOnnx() :_OrtMemoryInfo(Ort::MemoryInfo::CreateCpu(OrtAllocatorType::OrtDeviceAllocator, OrtMemType::OrtMemTypeCPUOutput)) {};
    ~ysOnnx() {};// delete _OrtMemoryInfo;
...
public:
    ...
    */
    ...
    void set_className(std::vector<std::string> class_names) {
        _className = class_names;
...
private:
    ...
    float _classThreshold = 0.4;
    float _nmsThreshold = 0.45;
    float _maskThreshold = 0.6;
